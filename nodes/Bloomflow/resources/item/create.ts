...
export const itemCreateDescription: INodeProperties[] = [
    // ─── Required Fields ─────────────────────────────────────────────────────────
    {
        displayName: 'Soft Upsert: If an item exists (same name or website), only empty fields will be updated.',
        name: 'behaviorNote',
        type: 'notice',
        default: '',
        displayOptions: {
    ...
    },
    {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether to enable item enrichment',
        displayOptions: {
            show: {
                resource: ['item'],
                operation: ['create'],
...

    {
        ...
        description:
            'Provide the full request body as a JSON object. The <code>typologyId</code> and <code>name</code> fields above will be merged in automatically. Example: <code>{"short_description":"AI startup","year_founded":"2020","tags":[{"name":"saas"}]}</code>.',
        routing: {
            request: {
