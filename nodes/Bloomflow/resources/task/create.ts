...
export const taskCreateDescription: INodeProperties[] = [
    {
        ...
        description: 'The typology of the parent item (used to filter the item and task template pickers)',
        modes: [
            {
    ...
    },
    {
        ...
        description: 'The item to create the task on. The server derives the workflow from this item.',
        modes: [
            {
    ...
    },
    {
        ...
        default: { mode: 'list', value: '' },
        description:
            'The task template to instantiate. List mode is populated from /api/public/items/tasks/reference_data, filtered by the selected typology.',
        displayOptions: {
            show: {
                resource: ['task'],
                operation: ['create'],
        ...
        modes: [
            {
                ...
                typeOptions: {
                    searchListMethod: 'getTaskTemplates',
                    searchable: true,
                    searchFilterRequired: false,
                },
            },
            {
                ...
                name: 'id',
                type: 'string',
                placeholder: 'e.g. 6745a1b2c3d4e5f6a7b8c9d1',
            },
            {
                displayName: 'By URL',
                name: 'url',
        ...
        routing: {
            request: {
                body: {
                    task_template_id:
                        '={{ (($parameter.taskTemplateId && $parameter.taskTemplateId.value) || $parameter.taskTemplateId || "").toString().match(/[a-f0-9]{24}/)?.[0] || (($parameter.taskTemplateId && $parameter.taskTemplateId.value) || $parameter.taskTemplateId) }}',
                },
            },
        },
    },
    {
        ...
        description: 'Comma-separated user IDs to assign to the task. At least one is required.',
        displayOptions: {
            show: {
                resource: ['task'],
                operation: ['create'],
    ...
    },
    {
        ...
        default: '',
        placeholder: 'userId1,userId2',
        description: 'Comma-separated user IDs to set as assigners. At least one is required.',
        displayOptions: {
            show: {
                resource: ['task'],
                operation: ['create'],
