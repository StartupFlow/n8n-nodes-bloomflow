...
export const taskCancelDescription: INodeProperties[] = [
    {
    ...
    },
    {
        ...
        required: true,
        default: { mode: 'id', value: '' },
        description: 'The task to cancel (reverts a completed task to pending or overdue based on its due date)',
        displayOptions: {
            show: {
                resource: ['task'],
                operation: ['cancel'],
        ...
        options: [
            {
                ...
                default: '',
                typeOptions: { rows: 3 },
                description: 'Optional feedback to attach when cancelling the task',
                routing: {
                    request: {
                        body: { feedback: '={{ $value }}' },
                    },
